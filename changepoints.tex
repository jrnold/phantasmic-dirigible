...
\item[Manual intervention] This includes an indicator variable for all years including and after 1899.
  ...
  \begin{equation}
    ...
    \end{cases}
  \end{equation}
\item[Normal distribution] In this model, the innovations are distributedn normal.
  ...
  \begin{equation}
    ...
    \end{aligned}
  \end{equation}
\item[Student $t$ distribution] In this model, the innovations are distributed Student $t$.
  ...
  \begin{equation}
    ...
    \end{aligned}
  \end{equation}
\item[Laplace distribution] In this model, the innovations are distributed Laplace $t$.
  \begin{equation}
    \label{dlm:eq:22}
    \begin{aligned}[t]
...
\begin{figure}[htpb!]
  ...
  \caption{Posterior distributions of $\mu_t$ for each model. The line is the posterior mean; the ranges of ribbon are the 2.5\% and 97.5\% percentiles.}
  \label{dlm:fig:nile_mu_posterior}
\end{figure}


% \subsection{American Civil War Currencies and Bonds}
% \label{dlm:sec:civil-war-greenbacks}
...
%  LocalWords:  PetrisPetroneEtAl2009
