...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}[t]{\linewidth}
   \includegraphics[width=\textwidth]{./bonds_and_battles//paper/figure/fives1874_price-1}
  \caption{Price in gold dollars. Par value is \$100.}
  \label{bonds:fig:fives1874_price}
\end{subfigure}
\begin{subfigure}[t]{\linewidth}
   \includegraphics[width=\textwidth]{./bonds_and_battles//paper/figure/fives1874_yield-1}
...
\begin{figure}[!htpb]
  \begin{subfigure}[t]{0.45\linewidth}
    \includegraphics[width=\textwidth]{./bonds_and_battles//paper/figure/fives1874_greenback_price-1}
...
\begin{subfigure}[t]{0.45\linewidth}
    \includegraphics[width=\textwidth]{./bonds_and_battles//paper/figure/fives1874_union-1}
...
%% \end{subfigure}
\begin{subfigure}[t]{0.45\linewidth}
  \includegraphics[width=\textwidth]{./bonds_and_battles//paper/figure/fives1874_graybacks-1}
...
The battles used in this analysis are listed in Tables~\ref{bonds:tab:battles_union} and \ref{bonds:tab:battles_confed}.
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=\textwidth]{./bonds_and_battles//paper/figure/fig_major_battles-1}
...
\input{./bonds_and_battles//paper/tex/tab_major_battles_union.tex}

\input{./bonds_and_battles//paper/tex/tab_major_battles_confed.tex}
...
\begin{align}
  ...
  X_{t, 1} &= \sum_{b \in B} W_{t,b} \qquad  \text{if $b$ is a Confederate victory,} \\
  X_{t, 2} &= \sum_{b \in B} W_{t,b} \qquad  \text{if $b$ is a Union victory,} \\
  W_{b,t} &= 
            \begin{cases}
...
This is equivalent to a model in which the effects of Confederate and Union victories are varying with an $AR(1)$ process,%
\footnote{
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=\textwidth]{./bonds_and_battles//paper/figure/fig_btl_effects-1}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[scale=0.9]{./bonds_and_battles//paper/figure/fig_btl_effects_ordered-1}  
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=\textwidth]{./bonds_and_battles//paper/figure/fig_btl_effects_time-1}  
