...
Prior to mid-1860, the yield of the Fives was low with little variation, fluctuating between 4.5 an5)} percent.%
\footnote{
...
After Lincoln's election in November 1860,  the interest rate rose t6)} percent.
After the initiation of the war with the Battle of Sumter (April 12--14, 1861), the yield rose t8.2)} percent.
During the war, between April 1861 and April 1865, the yield fluctuated betwee5.2)} an14.7)} percent, reaching its peak oJuly 30, 1864e}.
After the end of conflict in April 1865, the interest rate returned to stability a6.5)} percent, a rate higher than its pre-war level.
...
The proportions of the U.S. government revenues for each source of funding as follows: taxe72)}89)}\% from loans11)}25)}\% from taxes, an0)}4)}\% from miscellaneous sources (tariffs, land sales).
...
In 1860, the states that would make up the Confederacy accounted fo29)} percent of the overall U.S. population,%
\footnote{
...
At the height of the the Panic of 1857, the yield of U.S. government bonds, the 6's of 1868, only reache5.1)} percent.%
...
\begin{figure}[!]
  ...
  \begin{subfigure}[b]{\linewidth}
   \includegraphic../bonds_and_battles//paper/figure/fives1874_price-1)}}
  \caption{Price in gold dollars. Par value is \$100.}
  \label{bonds_battles:fig:fives1874_price}
\end{subfigure}
\begin{subfigure}[b]{\linewidth}
   \includegraphic../bonds_and_battles//paper/figure/fives1874_yield-1)}}
...
\begin{figure}[!]
  \begin{subfigure}[b]{0.45\linewidth}
    \includegraphic../bonds_and_battles//paper/figure/fives1874_greenback_price-1)}}
...
\begin{subfigure}[b]{0.45\linewidth}
    \includegraphic../bonds_and_battles//paper/figure/fives1874_union-1)}}
...
\begin{subfigure}[b]{0.45\linewidth}
  \includegraphic../bonds_and_battles//paper/figure/fives1874_graybacks-1)}}
...
This work will use43)} battles with the ``A'' military significance classification.%
\footnote{
...
While this is a subset of the battles, it is still a relatively large number of battles by most war standards and similar in number and composition as the list of battles in other sources: \textcite{Livermore1900} include63]} battles, \textcite{Bodart1908} include50]}, \textcite{cdb90} include49]}.
...
\begin{figure}[htpb]
  \centering
  \includegraphic../bonds_and_battles//paper/figure/fig_major_battles-1)}}
...
The data used in this paper include29s} Union victories12s} Confederate victories, and two ``Inconclusive'' battles.
...
\begin{table}
  \centering
  \inpu../bonds_and_battles//paper/tex/tab_major_battles.tex)}}
  \caption{List of th43)} major battles of the American Civil War included in this analysis.}
