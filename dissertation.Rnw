...
\addcontentsline{toc}{chapter}{Financial Markets and teh Onset of the American Civil War}
\label{cha:financ-mark-onset}

\include{Financial_Markets_and_Onset_of_the_American_Civil_War}

\chapter{Bonds and Battles: Financial Market Reactions to Battlefield Events in the American Civil War}
\addcontentsline{toc}{chapter}{Bonds and Battles: Financial Market Reactions to Battlefield Events in the American Civil War}
\label{cha:bonds-battles}

\include{Bonds_and_Battles}

\chapter{Bayesian Change Points and Linear Filtering in Dynamic Linear Models using Shrinkage Priors}
\addcontentsline{toc}{chapter}{Bayesian Change Points and Linear Filtering in Dynamic Linear Models using Shrinkage Priors}
\label{cha:structural-breaks}

\include{Structural_Breaks}
