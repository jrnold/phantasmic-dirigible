...
As dicussed in section~\ref{acw_onset:sec:risky-bond-pricing}, the suspension of interest did happen and was anticipated by investors.
...
The inverse logit transformation of $\pi$ evolves as a random walk with a horseshoe prior on the innovations to allow for change-points, as desribbed  in section~\ref{acw_onset:sec:south-north-yield}:
\begin{align}
