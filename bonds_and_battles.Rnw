...
With a non-zero $\tau$, and supposing $\omega$ was distributed normal, this would be equivalent to a constrained ARIMA(0, 1, 1) model \parencite[91]{PetrisPetroneCampagnoli2009}.
...
%%  LocalWords:  livermore Powell2006 HistoricalResearchEtAl1984 5's
