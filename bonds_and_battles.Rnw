...
At the height of the the Panic of 1857, the yield of U.S. government bonds, the Sixes of 1868, only reached \Sexpr{format_yields(yield_panic_1857)} percent.%
...
The data used in this work includes \Sexpr{union_victories} Union victories, \Sexpr{confederate_victories} Confederate victories, and two ``Inconclusive'' battles.
