...
The key feature of Equation (\ref{eq:3}) is that since all of the inputs of the price are in the expectations of the future conditioned on current information.
...
The yield to maturity of a coupon bond can be found by taking a known price and cash flow schedule in Equation (\ref{eq:3}) as solving for a single discount rate.
...
The American Civil War is a war with prentiful, and high quality battle-level data, and in which there are financial assets which proxy expected war outcomes well.
...
In the american  introduced several of the technologies later used in World War I and later: rifled artillery, telegraph, machine guns, barbed wire, ironclad warships, and submarines \parencites[89][]{Fuller1956a}[760]{Weiss1966}.
Second, the American Civil War was primarily a conventional war, which places it in the plurality of post-Cold War civil wars \parencite[423]{kalyvas2010inter}.%
...
Figures \ref{fig:fives1874_price} and \ref{fig:fives1874_yield} plot the price in gold dollars and the yield to maturity of the 5's of 1874.
Prior to mid-1860, the yield of the Fives was low with little variation, fluctuating between \Sexpr{format_yields(fives1874_yield_pre_war[["min"]])} and \Sexpr{format_yields(fives1874_yield_pre_war[["max"]])} percent.%
\footnote{
...
However, as with the 5's of 1874 versus other bonds,  Figure \ref{fig:fives1874_greenbacks} shows that the prices of the 5's of 1874 in gold dollars is similar in both level and trend as the the price of Greenbacks in gold dollars, so the choice is unlikely to change the results.
...
Since the cash flows of U.S. government bonds are not directly related to a war outcome, in order to treat those yields as a measure for a war outcome, I need to establish which war outcomes can influence future cash flows, and are the expectations about war outcome the only or primary factor influencing the yields.
The U.S. government bond yield could be related to both expectations about the whether the U.S. would win the war and the cost of the war to the U.S. government.
These have possibly cross-cutting effects, with U.S.\ victory postive and costs negative, and it is not possible to seperate these effects using on the U.S. government bond yields. 
However, it is likely that U.S.\ government bond yields mostly responded to expectations about the cost and duration of the war, and can be considered a proxy for the expected cost of the war to the U.S.

The riskiness of U.S. debt depended on expectations about the cost of the war to the U.S. since the war was funded primarily through debt.
...
In its analysis of the future fiscal situation, the 1863 \textit{Annual Report of the Treasury} notes that taxes and other revenue sources were enough to cover the non-war expenses and servicing the debt, but new debt was issued to pay military expenses for the war \parencite[10-13]{Treasury1863}.
Thus, both expectations of the government military expenditures and the length of the war, had a direct impact on expectations of the eventual debt level of the U.S. government.
And since increased debt would increase the possibility of default, it would make the bonds riskier, and the yields higher.
However, the future resources of the U.S. to pay that debt also depended on victory or defeat in the war.
If the U.S. reincorporating the states which seceded, then it would have a larger tax base with which to pay down the debt.
In 1860, the Southern states accounted for \Sexpr{round((9103333 / 31443316) * 100, 0)} percent of the overall U.S. population,%
\footnote{
...
\footnote{
  ...
  The closest contemporaries had to GDP was an approximation that the value of yearly production was about 25-27 percent of total wealth \parencite[7]{Elder1865}[24]{Treasury1865}.
}
...
The \textit{Annual Report of the Treasury Department} in 1863 highlighted this relationship between cost of the war and the 
\begin{quote}
...
The difference in the patterns of the price of U.S. bonds and the Confederate currency in Figure \ref{fig:fives1874_compared} is evidence that U.S. bond yields were not driven by expectations of U.S. victory, and, by elimination, likely represent the cost of war to the U.S.
...
Although the prices of Graybacks are partially influenced by money supply \parencite{BurdekinWeidenmier2001}, the price of Confederate bonds issued in Amsterdam and payable in gold are also decreasing from mid-1863 onward.
Since those assets suggest that the probability of Confederate victory was decreasing over the course of the war, if the U.S. bonds reflected the probability of U.S. victory, then the pattern we would expect to see is for yields to increase after the start of the war, and then by at least mid-1863 start decreasing almost monotonically for the remainder of the war. 
However, Figure \ref{fig:fives1874_yield} shows that the yields of bond prices fluctuate early in the war, and then spike in mid-1864 at a point which U.S. victory should have been highly probable.
This suggests that U.S. government interest rates are not primarily reflecting expectations of the war result, and are instead reflecing some other factor.

Finally, the financial benefit of victory and the costs and duration of war are inversely related.
The longer and more destructive, the less the ability of the Southern states to provide for the repayment of the debt incurred by the U.S. in fighting the war.
Immediately after the war, the U.S. government tried to collect direct taxes from the Southern states, but soon suspended this attempt.
In 1865, Treasury Secretary Hugh McCullough justified this suspension by noting that the inhabitants of the Southern states ``had been subject to heavy taxation by the government which was attempted to be established in opposition to that of the United States, ana had been greatly exhausted by the ravages of war.'' \parencite[29]{Treasury1865}.
In analyses of the repayment of debt after the war by the Treasury Department and others \parencites{Elder1865}{Treasury1865}{Walker1865a}, the wealth of the Confederate states was assumed to remain constant between 1860 and 1870, and not contribute to the repayment of the debt until after 1870.
The analysis of \textcite{GoldinLewis1975} shows that the income per capita of the Southern states did not return to the level expected by its ante-bellum trend until after 1900.

% todo: longer war reduced the pie. Confederacy in worse shape to repay the debt. E.g. ability to extract a direct tax.

One issue that is not a concern in this case, is the extent to which non-war events are influencing the yields of these bonds.
As noted earlier in this section, military expenses accounted for the overwhelming majority of U.S. government expenditures between 1861 and 1865.
The importance of the war can also be seen by comparing the level and variance of U.S. government bond yields during 1861 and 1865 with the preceeding period.
During that eras yields were stable at below 5 percent.
At the height of the the Panic of 1857, the yield of U.S. government bonds, the 6's of 1868, only reached \Sexpr{format_yields(yield_panic_1857)} percent. % 
Since a major financial crisis had little effect on bond yields prior to the war, there are certaintly no non-war omitted factors affecting the yields.
This is not to say that battles within the war are the only thing that is affecting the expectations of investors.
Government policies, elections, and other events could and almost certaintly did affect the expectations of the investors. 
But all of these events were  affecting the government bond yields through their effects on expectations of the war outcome.
...
twit  \caption{Yield to maturity of the 5's of 1874 compared with other U.S. bonds.}
...
Table \ref{tab:battles} lists these battles.
...
This work will use \Sexpr{nrow(major_battles)} battles with the military significance classification of ``A'', listed in Table \ref{tab:battles}.%
\footnote{
...
The data consist of \Sexpr{union_victories} Union victories and \Sexpr{confederate_victories} Confederate victories and no ``Inconclusive'' battles.%
\footnote{
...
Figure \ref{fig:major_battles} plots the date and outcomes of the  battles over time.
While CWSA
...
For this project, I created a public data collection of American Civil War battles, the American Civil War Battle Database \parencite{Arnold2015b}.
...
As noted in Section \ref{sec:5s-1874}, the yields of 5's of 1874 will be used for the measure of the interest rate.

As seen in Figure \ref{fig:fives1874_yield}, the variance of the changes in the yields tends to increase with the level. 
...
\footnote{Equation (\ref{eq:1}) is simplified for presentation. Since two sources are used, and in some cases there are multiple observations, $y_{t}$ is the mean of the observations, and $\tau_{t} = \tau / \sqrt{n_{t}}$ where $n_{t} \in \{1, 2\}$ is the number of observations on that day.}
\begin{align}
  \label{eq:6}
...
The error in Equation (\ref{eq:7}) is modeled as a stochastic volatility process,
\begin{equation*}
  \label{eq:9}
  \begin{aligned}[t]
...
The first issue is the lag of events.
  ...
  As noted in Section \ref{sec:battle-data}, battles Virginia were known the next day, but information from battles in the West would take longer to reach the market.
...
%  LocalWords:  bellum CBO2012 CBO2012a
