...
\begin{align}
  \label{eq:7}
  \mu_{t} &= \mu_{t - 1} + \alpha_{t} + W_{C,t} \kappa + W_{U,t} \upsilon + \omega_{\mu,t}
\end{align}
...
Equations XXXX constitute the model with I will be estimating.
I sample from posterior distribution of this model using an NUTS-HMC algorithm as implemented in the probabilistic programming language \Stan{} \parencites{\parencites{Stan2015a}.}
