...
Bond prices on April 13, 1861, immediately prior to news of the Battle of Fort Sumter reaching New York City implied only a \Sexpr{prwar_18610413} percent chance of war.%
...
This paper also adds to the growing international relations literature on the American Civil War, which has often been overlooked in the international relations literature as most work on civil wars focuses on civil wars after 1945 \parencites{Poast2012}{Reiter2009}.
This work employs methods similar to \textcite{HaberMitchenerOosterlinckEtAl2015}, which estimates the implied probability of victory by the Confederacy in the American Civil War and the Chinese government in the Chinese Civil War from bond prices by treating defeat of the issuing side as a default.
More broadly, this paper adds to the literature that analyzes the reactions of financial markets to conflict and political events.
Other papers which have analyzed the responses of financial markets to conflicts include: \textcite{Bueno1990}, \textcite{Hall2004} and \textcite{Ferguson2006} (World War I), and \textcites{WaldenstromFrey2008}{WaldenstromFrey2008} (World War II).
...
That the prices of Southern state bonds never came close to zero, suggests that investors' beliefs put positive probability on those states being reincorporated into the United States or that they would resume payments on their debt after the war even in the event of a Confederate victory.
...
The data consist of bonds issued by nine states (Georgia, Indiana, Kentucky, Louisiana, Missouri, North Carolina, Ohio, Pennsylvania and Virginia) and two bonds issued by the U.S. government (Sixes of 1868, Fives of 1874).%
\footnote{In the financial jargon of that era, Fives or 5's refers to coupon bonds paying 5 percent interest, and Sixes or 6's to bonds paying 6 percent interest.}
...
The two government bonds  in the data were only issued in extraordinary circumstances: the Sixes of 1868 were issued in 1847 and 1848 to pay for the Mexican-American War, while Fives of 1874 were issued in 1858 due to a funding shortfall as a result of a financial crisis, the Panic of 1857  \parencites[297-302]{HomerSylla2005}[72-73,76]{DeKnight1900}
...
For example, a price is given for ``Virginia Sixes'', but Virginia issued multiple coupon bonds paying 6 percent semi-annually with redemption dates between 1885 and 1890.
...
\begin{figure}
  \centering
  \includegraphics{\Sexpr{file.path(PROJECT_DIR, "figures/fig_yields_all-1")}}
...
\begin{figure}
  \centering
  \includegraphics{\Sexpr{file.path(PROJECT_DIR, "figures/fig_yields_election-1")}}
...
\begin{figure}
  \centering
  \includegraphics{\Sexpr{file.path(PROJECT_DIR, "figures/fig_yields_sumter-1")}}
...
Figure~\ref{fig:yields_all} plots the yields of all the bonds in the data from \Sexpr{date_bdy(DATE_PRICES_START)} to \Sexpr{DATE_WAR_START_END}.
...
The yields of the U.S. Sixes of 1868 were between \Sexpr{round(prices_prewar_period_bond["U.S. Sixes, 1868:Pre Panic of 1857", "ytm_min"], 2)} and \Sexpr{round(prices_prewar_period_bond["U.S. Sixes, 1868:Pre Panic of 1857", "ytm_max"], 2)} percent.
...
The causes of the panic were not directly related to political risks of secession or war, but were likely a decline in European demand for U.S. imports or insufficient specie supply to meet demand due to a decline in gold production \parencites[263-265]{Dewey1918}[277,299]{HomerSylla2005}[337]{BankersMagazine1857}.
...
The initial increase in yields was due to a small financial crisis that started when Southern banks started denying credit to Northern clients and withdrew specie from Northern banks \parencite[76]{HomansDana1861a}.
...
\begin{figure}
  \centering
  \includegraphics{\Sexpr{file.path(PROJECT_DIR, "figures/fig_yields_regions-1")}}
...
\begin{figure}
  \centering
  \includegraphics{\Sexpr{file.path(PROJECT_DIR, "figures/fig_north_south_spreads-1")}}
...
The data used to calculate the south-north yield spread consist of the yields of Northern (Indiana, Ohio and Pennsylvania) and Southern (Georgia, Louisiana, North Carolina, Tennessee and Virginia).
...
Between the start of the period (July 1, 1855) and prior to the election of 1860 (November 2, 1860), the spread increased by \Sexpr{spreads_diff_1855_elec_fmt},
...
The spread increases sharply after the election of Lincoln, from November 2, increasing by \Sexpr{spreads_diff_elec_fmt} percentage points to \Sexpr{spreads_postelec_fmt} on December 7, 1860.
...
\end{equation}
For each bond, $r_{j}$ is its average yield from \Sexpr{DATEFMT_PEACE_START} to \Sexpr{DATEFMT_PEACE_END}.%
\footnote{
...
More precisely, the $R_{j,t}$ is the present value of bond $j$ at time $t$ calculated using the average yield of the bond \Sexpr{DATEFMT_WAR_START} to \Sexpr{DATEFMT_WAR_END}.%
...
Second, although the implied probabilities increase to between \Sexpr{PRWAR1_MIN} and \Sexpr{PRWAR1_MAX} percent.
...
The inverse logit transformation of $\pi$ evolves as a random walk with a horseshoe prior on the innovations to allow for change-points, as described  in section~\ref{sec:south-north-yield}:
\begin{align}
...
After the election, the probability of war rose to \Sexpr{prwar_18610105} percent by January 5, 1861,
to \Sexpr{prwar_18610208} percent on February 8, and to \Sexpr{prwar_18610413} on April 13, days before news of the outcome of the Battle of Fort Sumter reached the market.
...
\begin{figure}
  \centering
  \includegraphics{\Sexpr{file.path(PROJECT_DIR, "figures/fig_prwar1-1")}}
...
\begin{figure}
  \centering
  \includegraphics{\Sexpr{file.path(PROJECT_DIR, "figures/fig_prwar2-1")}}
...
Although the seeds of the American Civil War preceded the start of the war for many years, the onset of war was unexpected by financial markets.
...
%%  LocalWords:  Merchants' HomansDana1861a Treasury1861a Bankers'
