...
knitr::opts_chunk[["set"]](error = FALSE,
                           echo = TRUE,
                           cache = FALSE)
fig_path <- file.path(PROJECT_ROOT, "dissertation")
tab_path <- fig_path
@

Political and social processes are rarely, if ever, constant over time,
meaning that political scientists often have a need to estimate time-varying parameter (TVP) models.
...
\begin{figure}
  \centering
  % \includegraphics{\Sexpr{file.path(fig_path, "fig-horseshoe1")}}
  % \includegraphics{\Sexpr{file.path(fig_path, "fig-horseshoe2")}}
...
\begin{figure}[htpb]
  ...
  \begin{subfigure}{1.0\textwidth}
    %\includegraphics{\Sexpr{file.path(fig_path, "fig-nile1")}}
    \caption{\Model{nile}{hs}}
    \label{fig:nile-posterior-1}    
  \end{subfigure}
  \begin{subfigure}{1.0\textwidth}
    %\includegraphics{\Sexpr{file.path(fig_path, "fig-nile2")}}
    \caption{\Model{nile}{normal3}}
    \label{fig:nile-posterior-2}
  \end{subfigure}
  \begin{subfigure}{1.0\textwidth}
    %\includegraphics{\Sexpr{file.path(fig_path, "fig-nile3")}}
...
\begin{table}[htpb]
  \centering
  % \input{\Sexpr{file.path(tab_path, "tab-nile-fits.tex")}}
...
\begin{figure}[htpb]
  \centering
  %\includegraphics{\Sexpr{file.path(fig_path, "fig-nile-omega")}}
...
\begin{figure}[htpb]
  \centering
  %\includegraphics{\Sexpr{file.path(fig_path, "fig-nile-lambda")}}
...
\begin{table}[htpb]
  \centering
  % \input{\Sexpr{file.path(tab_path, "tab-bush-fits.tex")}}
...
\begin{figure}[htpb]
  \centering
  \begin{subfigure}{1.0\textwidth}
    %\includegraphics{\Sexpr{file.path(fig_path, "fig-bush1")}}
    \caption{\Model{bush}{hs}}
    \label{fig:bush1}
  \end{subfigure}
  \begin{subfigure}{1.0\textwidth}
    %\includegraphics{\Sexpr{file.path(fig_path, "fig-bush2")}}
